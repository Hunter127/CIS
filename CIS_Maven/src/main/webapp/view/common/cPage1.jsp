							...
							<div class="search_center">
								...
								<div class="ph_left_1_2_in">
									...
									<div class="pl12_search">
										<a id="searchBtn" class="pl12_s_btn" onclick="document.getElementById('Sub3').submit();return false"><img
						...
						<div class="myBox2">
							<div id="main-top">
								<ul class="nav nav-tabs">
									<li role="presentation"><a href="<%=request.getContextPath()%>/change.jsp">最新信息</a></li>
									<li role="presentation" class="active"><a href="#">关注企业</a></li>
