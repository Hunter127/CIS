							...
							<div class="search_center">
								...
								<div class="ph_left_1_2_in">
									...
									<div class="pl12_search">
										<a id="searchBtn" class="pl12_s_btn" onclick="document.getElementById('Sub5').submit();return false"><img
						...
						<div class="myBox2">
							<div id="main-top">
								<ul class="nav nav-tabs">
									...
									<li role="presentation"><a href="class="active"">其他</a></li>
