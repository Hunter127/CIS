        ...
        <form  method="post" action="login" id="registForm"  enctype="multipart/form-data" >
            ...
            <div class="form" >
                <div class="item" id="select-regName">
                    ...
                    <tr>
                       <div class="o-intelligent-regName">
                            <input type="text" id="regName" name="username" maxlength="20" class="text" datatype="*3-15" nullmsg="请输入帐号！" errormsg="帐号范围在3~15位之间"/>
                        </div> 
                ...
                <div id="o-password">
                    ...
                    <tr>
                        <div class="o-intelligent-regName">
                            <input type="password" id="pwd" name="password" maxlength="20" class="text" datatype="*6-15" nullmsg="请输入密码！" errormsg="密码范围在6~15位之间！" />
                           </div>
                            <td><div id="accountValidate" class="Validform_checktip"></div></td>
                        </tr> </table>  
                        </div>
